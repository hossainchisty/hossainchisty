...
### 💪 Skills & Technologies
![](https://skillicons.dev/icons?i=js,ts,nodejs,express,nestjs,py,django,fastapi,react,nextjs,mongodb,sqlite,postgresql,redis,aws,docker,kubernetes,githubactions)
